...
*   **Total Review Volume Cap:** Capped at **2,000 reviews** per analysis run.
*   **Equal Platform Distribution:** Exactly **400 reviews** are collected per platform group to ensure unbiased comparative analysis:
    ...
    2.  **Apple App Store:** Ingested referencing the product URL `https://apps.apple.com/us/app/spotify-music-and-podcasts/id324684580` (fetched via iTunes customer reviews feed).
    3.  **Community Forums:** Ingested tracking the official boards `community.spotify.com/t5/Help`, `community.spotify.com/t5/Ongoing-Issues`, and `community.spotify.com/t5/Ideas`.
...
### 4.1 System Components & Stack
1.  **Frontend Interface (Streamlit Dashboard):**
    ...
    *   **Q&A Insights at Bottom:** The 6 core Product Discovery Q&A panels are positioned at the very bottom of the dashboard.
2.  **Backend Integration (FastAPI Layer):**
